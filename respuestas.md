...
nos sirve cuando tenemos variables o bloques de codigo muy parecidos (con cambios que podrian ser parametros o argumentos) que podemos encapsular para reutilizar mas de una vez en el futuro.

Tambien nos sirve para ordenar y mejorar la legibilidad de nuestro codigo.

- ¿Cuál es la diferencia entre parámetros y argumentos de una función?

Las funciones reciben párametros cuando las creamos. y les enviamos argumentos cuando las ejecutamos. 
...
function saludo(name , lastName, nickName) {
    ...
    console.log("Mi nombre es " + completeName + ", prefiero que me digas" + nickName + ".");
}
...
Son la forma en que ejecutamos un bloque de código u otro dependiendo de alguna condicion o validación.
...
Es cuando la validación de nuestros condicionales nunca se cumple y termina toteando (dañando) la aplicación (e.j. cuando el navegador no puede mas de tanta ejeción de ese bloque de código.)

- ¿Puedo mezclar ciclos y condicionales?

Si, aunque los ciclos son una especie de condicionales, nada nos impide agragar más condiconales dentro del ciclo.
